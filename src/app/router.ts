...
export const routes: RouteRecordRaw[] = [
  { path: "/", name: "dashboard", component: () => import("../features/dashboard/DashboardPage.vue"), meta: { title: "今日决策", section: "home" } },
  { path: "/accounts/:accountId", name: "account", component: () => import("../features/accounts/AccountPage.vue"), meta: { title: "账号详情", section: "accounts" } },
  ...
  { path: "/plans/upgrades", name: "upgrades", component: () => import("../features/plans/UpgradesPage.vue"), meta: { title: "升级计划", section: "plans" } },
  { path: "/plans/beasts", name: "beasts", component: () => import("../features/plans/BeastsPage.vue"), meta: { title: "神兽计划", section: "plans" } },
  { path: "/plans/timeline", name: "timeline", component: () => import("../features/plans/TimelinePage.vue"), meta: { title: "联合时间轴", section: "plans" } },
  ...
  { path: "/data", redirect: "/data/market" },
  { path: "/data/:section(market|resources|tasks|sources)", name: "data-center", component: () => import("../features/data/DataCenterPage.vue"), meta: { title: "数据中心", section: "data" } },
