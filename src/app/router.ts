...
export const routes: RouteRecordRaw[] = [
  ...
  { path: "/plans/gems", name: "gem-plan", component: () => import("../features/plans/UpgradesPage.vue"), meta: { title: "宝石计划", section: "plans" } },
  { path: "/plans/beasts", name: "beasts", component: () => import("../features/plans/BeastsPage.vue"), meta: { title: "神兽主线任务", section: "plans" } },
  { path: "/plans/tasks", name: "plan-tasks", component: () => import("../features/plans/TaskMaintenancePage.vue"), meta: { title: "任务维护", section: "plans" } },
  { path: "/plans/timeline", name: "timeline", component: () => import("../features/plans/TimelinePage.vue"), meta: { title: "五号主线概览", section: "plans" } },
  { path: "/plans/parameters", name: "plan-parameters", component: () => import("../features/plans/PlanParametersPage.vue"), meta: { title: "计划参数", section: "plans" } },
  ...
  { path: "/data/:section(inventory|market|sources)", name: "data-center", component: () => import("../features/data/DataCenterPage.vue"), meta: { title: "数据中心", section: "data" } },
