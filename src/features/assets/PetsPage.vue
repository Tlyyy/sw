...
const query = ref(String(route.query.q || "")); const account = ref(String(route.query.account || ui.accountScope)); const role = ref(String(route.query.role || "ALL")); const status = ref(String(route.query.status || "ALL"));
