...
const types=["兽决","御兽","强化技能"] as const;const type=ref(String(route.query.type||"兽决"));const query=ref(String(route.query.q||""));
